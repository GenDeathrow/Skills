 ...
 */
	...
	public static void drawScreenOverlay(int par1, int par2, int par5)
	{
	    ...
	    WorldRenderer renderer = tessellator.getWorldRenderer();
	    renderer.startDrawingQuads();
	    renderer.addVertexWithUV(0.0D, (double)par2, -90.0D, 0.0D, 1.0D);
	    renderer.addVertexWithUV((double)par1, (double)par2, -90.0D, 1.0D, 1.0D);
	    renderer.addVertexWithUV((double)par1, 0.0D, -90.0D, 1.0D, 0.0D);
	...
	public static void scaledTexturedModalRect(int x, int y, int u, int v, int width, int height, int scale)
	{
	    ...
	    WorldRenderer renderer = tessellator.getWorldRenderer();
	    renderer.startDrawingQuads();
		renderer.addVertexWithUV((double)(x + 0), (double)(y + (height * scale)), 0, (double)((float)(u + 0) * f), (double)((float)(v + height) * f1));
		renderer.addVertexWithUV((double)(x + (width * scale)), (double)(y + (height * scale)), 0, (double)((float)(u + width) * f), (double)((float)(v + height) * f1));
		renderer.addVertexWithUV((double)(x + (width * scale)), (double)(y + 0), 0, (double)((float)(u + width) * f), (double)((float)(v + 0) * f1));
		renderer.addVertexWithUV((double)(x + 0), (double)(y + 0), 0, (double)((float)(u + 0) * f), (double)((float)(v + 0) * f1));
		tessellator.draw();
	}
